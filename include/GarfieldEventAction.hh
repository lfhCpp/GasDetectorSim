...
class GarfieldEventAction : public G4UserEventAction {
 public:
  ...
  static G4double transfer(double t);
 ...
 private:
  ...
  G4double fGain;
  G4double fThisEventID;
  G4double fAnodeSignal[3000];
  G4double fCathodeSignal[3000];
  G4double fGridSignal[3000];
  G4double fAnodeVoltageSignal[3000];
  G4double fCathodeVoltageSignal[3000];
  G4double fGridVoltageSignal[3000];
};
