...
class GarfieldDetectorConstruction : public G4VUserDetectorConstruction {
 ...
 private:
  ...
  G4VPhysicalVolume* fChamberPV = nullptr;  // cathode physical volume
  G4LogicalVolume* logicWire[188];
  G4VPhysicalVolume* physWire[188];
  G4LogicalVolume* logicAnode[8];
  G4VPhysicalVolume* physAnode[8];
