...
GarfieldRunAction::GarfieldRunAction() : G4UserRunAction() {
  ...
  analysisManager->CreateH3("1", "Track position", 200, 0* cm, 10 * cm, 200,
                            0.0 * cm, 20.0 * cm, 200, 0.0 * cm, 20.0 * cm);
...
//  analysisManager->FinishNtuple();
  ...
  //
  analysisManager->CreateNtuple("tt", "EventID and Signal");
  analysisManager->CreateNtupleDColumn("EventID");
  analysisManager->CreateNtupleDColumn("AnodeSignal");
  analysisManager->CreateNtupleDColumn("CathodeSignal");
  analysisManager->CreateNtupleDColumn("GridSignal");
  analysisManager->FinishNtuple();
}
